...
# TODO
- spare matrix: output of scikit-learn `OneHotEncoder`
- `scipy.stats`
...
* [Scientific Python Lectures](https://lectures.scientific-python.org/): NumPy, Matplotlib, SciPy, Sympy, scikit-learn