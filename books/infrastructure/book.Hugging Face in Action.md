...
action: [hack-hugging-face](../../codes/hack-llm/README.md#hugging-face-in-action)
...
datasets
- the Internet Movie Database (IMDb) dataset - https://huggingface.co/datasets/stanfordnlp/imdb
- the Stanford Sentiment Treebank (SST-2) dataset

pretained transformer models
- BERT
