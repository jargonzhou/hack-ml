"""
This generates quizzes based on the ingested materials and the user’s current knowledge
"""
...
from app.pits.global_settings import INDEX_STORAGE, QUIZ_SIZE, QUIZ_FILE
...
def build_quiz(topic):
  ...
  df_rows_program = DFRowsProgram.from_defaults(
      ...
      pydantic_program_cls=LLMTextCompletionProgram,
      df=df,
      verbose=True)
